<template>
  <div>
    <SelectComponent v-model="sortType" />
    <section
...
let sortType = ref(1);
let defaulSort = ref(null);
watch(sortType, () => {
  if (defaulSort.value === null) {
    defaulSort.value = JSON.parse(JSON.stringify(cards.value));
  }
  if (sortType.value === 2) {
